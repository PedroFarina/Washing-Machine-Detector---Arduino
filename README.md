...
- Once it detects the first vibration spends 5 minutes making sure the vibrations are constants (if it stops for more than 30s it goes back to Idle)
- Once it makes sure that it's indeed something repetitive vibrating going on it wait after 5 minutes of not vibrating anymore to trigger a Motion Detected on HomeKit app
